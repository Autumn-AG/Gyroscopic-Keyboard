...
// #include "paj7620.h" // Gesture Sensor Lib
// const int Touch = 2;
...
{ 
  int TouchVal = digitalRead(Touch);
	...
	// if (data == GES_UP_FLAG) {Serial.println("Detect Up");}
	// if (data == GES_DOWN_FLAG) {Serial.println("Detect Down");}
  // if (data == GES_LEFT_FLAG) {Serial.println("Detect Left");}
	// if (data == GES_RIGHT_FLAG) {Serial.println("Detect Right");}
